                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        <li>
                            ...
                            <div class="dropdown-menu dropdown-menu-end " aria-labelledby="navbarDropdown">
                                <a class="dropdown-item text-right" href="{{ route('annonce/create') }}" onclick="event.preventDefault();
                                                     document.getElementById('add-annonce-form').submit();">
                                    Ajouter une annonce
                                </a>

                                <form id="add-annonce-form" action="{{ route('annonce/create')  }}" method="POST" class="d-none">
                                    @csrf
                                </form>
                            </div>
                        </li>
